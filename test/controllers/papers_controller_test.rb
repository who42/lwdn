...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { autores: @paper.autores, año: @paper.año, descarga: @paper.descarga, id: @paper.id, idioma: @paper.idioma, título: @paper.título }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { autores: @paper.autores, año: @paper.año, descarga: @paper.descarga, id: @paper.id, idioma: @paper.idioma, título: @paper.título }
    assert_redirected_to paper_path(assigns(:paper))
  end
